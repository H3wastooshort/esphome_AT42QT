...
std::map<AT42QTRegister, uint8_t> reg_AT42QT1060 {
  {CHIP_ID, 0},
  {VERSION, 1},
  {STATUS, 4},
  {CALIBRATE, 12},
...
std::map<AT42QTRegister, uint8_t> reg_AT42QT1070 {
  {CHIP_ID, 0},
  {VERSION, 1},
  {STATUS, 2},
  {KEY_SIGNAL, 4},
...
std::map<AT42QTRegister, uint8_t> reg_AT42QT2120 {
  {CHIP_ID, 0},
  {VERSION, 1},
  {STATUS, 2},
  {CALIBRATE, 6},
...
std::map<AT42QTRegister, uint8_t> reg_AT42QT2160 {
  {CHIP_ID, 0},
  {VERSION, 1},
  {STATUS, 2},
  {SUB_REVISION, 7},
