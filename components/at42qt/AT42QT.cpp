...
const char *const TAG = "at42qt";
const LogString *const MSG_CHIP_ID_INCORRECT = LOG_STR("Read invalid chip ID! Check part number and wiring.");
...
void AT42QTDebug::update() {this->wants_update=true;};
